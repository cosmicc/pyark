...
#print(f'{RST}{RED}RED {RED}{LREV}RRED {BLU}BLUE {CYN}CYAN {BCYN}BCYAN {YEL}YELLOW {BYEL}BYELLOW {PNK}PINK {PUR}PURPLE {BRN}BROWN {GRN}GREEN {BGRN}BGREEN {BGN}BLUGREEN {ORG}ORANGE {SKN}SKIN {MAU}MAUVE {RMY}ARMY {SLT}SLATE{RST}')
