...
log.level('TRAP', no=3, color="<fg 111>", icon="¤")
log.level('DEATH', no=3, color="<fg 163>", icon="¤")
log.level('TAME', no=3, color="<fg 113>", icon="¤")
log.level('RELEASE', no=3, color="<fg 99>", icon="¤")
log.level('DECAY', no=3, color="<fg 196>", icon="¤")
log.level('DEMO', no=3, color="<fg 202>", icon="¤")
