...
log.add(
    ...
    delay=False,
    filter=checklogpoints,
)

# Admin Logging admin.log
log.add(
    sink=str(adminlogfile),
    level=3,
    buffering=1,
    enqueue=True,
    backtrace=False,
    ...
    format=simplelogformat,
    delay=False,
    filter=checklogadmin,
)

# Crash Logging crash.log
log.add(
    sink=str(crashlogfile),
    level=29,
    buffering=1,
    enqueue=True,
    backtrace=False,
    ...
    format=simplelogformat,
    delay=False,
    filter=checklogcrash,
)

# Error Logging error.log
log.add(
    sink=str(errorlogfile),
    level=40,
    buffering=1,
    enqueue=True,
    backtrace=True,
