...
new player to cluster.')
        ...
        if inst == pexist[15]:
            log.info(f'player {playername} with steamid {steamid} was found on home server {inst}. updating info.')
            ...
            log.info(f'player {playername} with steamid {steamid} was found on NON home server {inst}. updating info.')
